...
const projectSections = [
  ...
  },
  {
    ...
    desc: 'Players edit a summer camp newspaper by cross-referencing conflicting witness accounts and evidence.',
    tags: ['Godot 4', 'GDScript', 'Narrative Systems'],
    media: { type: 'youtube', youtubeId: 'SXn_OBy1RS4' },
    externalUrl: 'https://www.youtube.com/watch?v=SXn_OBy1RS4',
    externalLabel: 'Project Video',
    photos: [
